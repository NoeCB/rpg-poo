...
/**
 * Representa al Animatrónico, un asesino (killer) del juego inspirado en "Five
 * Nights at Freddy's".
 * <p>
 * El Animatrónico es un killer mecanizado de alta resistencia que acecha a los
 * supervivientes
 * con movimientos y sonidos aterradores. Su vida máxima de 220 puntos lo
 * posiciona como uno de
 * los asesinos más resistentes del juego, capaz de perseguir sostenidamente a
 * sus presas.
 * </p>
 * Con una defensa base de 20, el Animatrónico puede mitigar un daño adicional
 * de 4 puntos
...
public class Animatronico extends Personaje {
    /**
     * Constructor que inicializa la instancia del Animatrónico con sus atributos
     * específicos.
     * <p>
     ...
     * inicial)</li>
     * </ul>
     * El Animatrónico hereda todas las mecánicas de combate base de la clase
     * {@link Personaje},
    ...
    /**
     * Ejecuta la acción específica del Animatrónico cuando es su turno (método
     * abstracto implementado).
     * <p>
     * El Animatrónico emite un sonido mecánico aterrador, basándose en sus orígenes
     * de
     * "Five Nights at Freddy's". Este método es principalmente de flavour/narrativa
     * y se
